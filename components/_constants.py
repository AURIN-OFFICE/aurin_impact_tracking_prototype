...
FOR_TIERS: Dict[str, Dict] = {
    ...
    "330499": {"name": "Urban and regional planning not elsewhere classified",                      "tier": "Core"},
    # Demography (4403)
    "4403":   {"name": "Demography",                                           "tier": "Core"},
    "440302": {"name": "Fertility",                                            "tier": "Core"},
    "440303": {"name": "Migration",                                            "tier": "Core"},
    "440304": {"name": "Mortality",                                            "tier": "Core"},
    "440305": {"name": "Population trends and policies",                       "tier": "Core"},
    # Development studies (4404) — development subcodes
    "4404":   {"name": "Development studies",                                 "tier": "Core"},
    "440401": {"name": "Development cooperation",                             "tier": "Core"},
    "440402": {"name": "Humanitarian disasters, conflict and peacebuilding",                       "tier": "Core"},
    "440403": {"name": "Labour, migration and development ",                               "tier": "Core"},
    "440404": {"name": "Political economy and social change",              "tier": "Core"},
    "440405": {"name": "Poverty, inclusivity and wellbeing",                               "tier": "Core"},
    "440406": {"name": "Rural community development",                          "tier": "Core"},
    "440407": {"name": "Socio-economic development",                           "tier": "Core"},
    "440408": {"name": "Urban community development",                          "tier": "Core"},
    "440499": {"name": "Development studies not elsewhere classified",         "tier": "Core"},
    ...
    "440606": {"name": "Political geography",                                  "tier": "Core"},
    "440607": {"name": "Population geography",                                 "tier": "Core"},
    "440608": {"name": "Recreation, leisure and tourism geography",            "tier": "Core"},
    ...
    "440702": {"name": "Crime policy",                                         "tier": "Core"},
    "440703": {"name": "Economic development policy",                          "tier": "Core"},
    "440704": {"name": "Environment policy",                                   "tier": "Core"},
    "440705": {"name": "Gender, policy and administration",                    "tier": "Core"},
    "440706": {"name": "Health policy",                                        "tier": "Core"},
    "440707": {"name": "Housing policy",                                       "tier": "Core"},
    "440709": {"name": "Public policy",                                        "tier": "Core"},
    "440710": {"name": "Research, science and technology policy",              "tier": "Core"},
    "440711": {"name": "Risk policy",                                          "tier": "Core"},
    "440712": {"name": "Social policy",                                        "tier": "Core"},
    "440713": {"name": "Tourism policy",                                       "tier": "Core"},
    "440714": {"name": "Urban policy",                                         "tier": "Core"},
    # Spatial data and geomatics
    "4013":   {"name": "Geomatic engineering",                                 "tier": "Core"},
    "401301": {"name": "Cartography and digital mapping",                      "tier": "Core"},
    "401302": {"name": "Geospatial information systems and geospatial data modelling", "tier": "Core"},
    "401303": {"name": "Navigation and position fixing",                       "tier": "Core"},
    "401304": {"name": "Photogrammetry and remote sensing",                    "tier": "Core"},
    "401305": {"name": "Satellite-based positioning",                          "tier": "Core"},
    "401306": {"name": "Surveying (incl. hydrographic surveying)",             "tier": "Core"},
    "401399": {"name": "Geomatic engineering not elsewhere classified",        "tier": "Core"},
    ...
    "3509":   {"name": "Transportation, logistics and supply chains",           "tier": "Related"},
    ...
    "4505":   {"name": "Aboriginal and Torres Strait Islander peoples, society and community", "tier": "Contextual"},
    "4511":   {"name": "Māori peoples, society and community", "tier": "Contextual"},
    "4503":   {"name": "Aboriginal and Torres Strait Islander environmental knowledges and management", "tier": "Contextual"},
